    ...
    <div class="container_admin">
        ...
        <div class="admin_navigation">
            <ul>
                ...
                <li class="dropdown"><a href="products.php"><i class="fa-solid fa-box"></i> Products<i class="fa-solid fa-caret-down"></i></a>
                    <div class="dropdown-content">
                        <a class="active" href="Includes/add_products.php" target="_blank">Add Product</a>
